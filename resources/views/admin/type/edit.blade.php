                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table text-md-nowrap" id="type">
                                    <thead>
                                        <tr>
                                            <th class="wd-15p border-bottom-0">  الوحدات بالانجليزيه  </th>
                                            <th class="wd-15p border-bottom-0">  الوحدات بالعربيه   </th>
                                            <th class="wd-15p border-bottom-0">  الوحدات بالفرنسيه   </th>
